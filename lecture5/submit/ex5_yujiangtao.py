...
def load_dataset():
    ...
    classes = np.zeros((1, 1))
    # ===================== YOUR CODE HERE =====================================
    train_datasets = h5py.File('F:\Work/lecture5/lecture5/datasets/train_catvnoncat.h5','r')      
    ...
    test_datasets = h5py.File('F:\Work/lecture5/lecture5/datasets/test_catvnoncat.h5','r')
...
if __name__ == "__main__":
    ...
    os.chdir('F:\\Work\lecture5\lecture5')
